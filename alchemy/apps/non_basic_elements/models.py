...
class NonBasicElement(Element):
    element1=models.ForeignKey(Element,models.RESTRICT, related_name='nonBasicElement_element1')
    element2=models.ForeignKey(Element,models.RESTRICT, related_name='nonBasicElement_element2')
